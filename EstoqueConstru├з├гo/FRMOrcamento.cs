    ...
    public partial class FRMOrcamento : Form
    {
        ...
        private void PDOrcamento_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            for (int i = 0; i < DGVProdutos.RowCount - 1; i++) //percorre as linhas 
            {
                ...
                {
                    e.Graphics.DrawString(myList[1, i], fonteB, caneta, 10, heightProd);
                    e.Graphics.DrawString(myList[2, i], fonteB, caneta, 145, heightProd);
                    e.Graphics.DrawString(myList[3, i], fonteB, caneta, 235, heightProd);
                    e.Graphics.DrawString(myList[4, i], fonteB, caneta, 325, heightProd);
            ...
            e.Graphics.DrawString(TXTValorItems.Text, fonteB, caneta, 300, 570);
